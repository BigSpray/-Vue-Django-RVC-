<template>
    <div style="display: flex;">
        <div style="flex: 1;">
            <div style="justify-content: space-between;margin: 20px 5px;padding:0 0 0 15px;border-left: 10px solid #0a9af3;display: flex;align-items: center;">
            ...
            <div class="card" style="height: 707.55px; position: relative;">
                <div v-if="displayblog">
                        ...
                        <div @click="gohorseshow('/main/detail?id=' + item.id, item)" style="cursor: pointer; padding: 15px;display: flex;justify-content: space-between;flex: 1;border-bottom: 1px dotted #0a9af3;">
                            <div>
                    ...
                    <div style="position: absolute; bottom: 0; width: 100%; box-sizing: border-box; padding: 10px;">
        ...
        <div style="width: 200px;height: 100px;">
            <div class="card" style="width: 130px;">
                <el-statistic title="已发布杂谈" :value="total" >
                <template #prefix>
    ...
    methods: {
        getData() {
            ...
            axios.get("http://127.0.0.1:8000/getblogs").then((res) => {
                ...
                const filteredBlogs = this.all.filter(blog => blog.forblog === '游我杂谈');
