<template>
    <div class="card" style="margin-bottom: 5px;">
        <el-input style="width: 250px;margin-right: 10px;" v-model="inputdata" prefix-icon="Search" placeholder="请输入标题查询"></el-input>
        <el-button type="primary" @click="searchBlogs">查 询</el-button>
...
export default {
    ...
    methods: {
        ...
        searchBlogs() {
            ...
            if (keyword) {
                this.allData = this.allData.filter(item => item.title.includes(keyword));
            } else {
